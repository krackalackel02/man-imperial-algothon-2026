...
def run_pipeline(
    ...
    # 3. Instantiate model
    print(f"[3/4] Building model ({model_cls.__name__}) ...")
    model: BaseModel = model_cls(clean_data)
